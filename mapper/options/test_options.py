...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--num_of_ref_img', default=30, type=int, help='Number of reference images used for each target')
		self.parser.add_argument('--checkpoint_path', default="../checkpoints/HairManip_model.pt", type=str, help='Path to model checkpoint')
		...
		self.parser.add_argument('----no_morefine_mapper', default=False, action="store_true")
